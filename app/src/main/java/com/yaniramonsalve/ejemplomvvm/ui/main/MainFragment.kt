package com.yaniramonsalve.ejemplomvvm.ui.main
...
import com.yaniramonsalve.ejemplomvvm.databinding.MainFragmentBinding
...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.sumaDone.observe(viewLifecycleOwner, { it ->
